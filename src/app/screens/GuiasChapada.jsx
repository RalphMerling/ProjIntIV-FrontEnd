...
const guides = [
  {
    ...
    price: "R$ 400/dia",
    rating: "4.8",
    reviews: "107 avaliações",
    experience: "10 anos de experiência",
    description:
      "Geógrafo e aventureiro, guio expedições pelas formações rochosas mais antigas do cerrado brasileiro.",
    image: require("../assets/images/Lucas.png"),
    languages: ["Português", "Inglês"],
    specialties: ["Cachoeiras", "Trekking", "Geologia"],
  },
  {
    id: 2,
    name: "Aline Ribeiro",
    ...
    price: "R$ 370/dia",
    rating: "4.7",
    reviews: "82 avaliações",
    experience: "7 anos de experiência",
    description:
      "Fotógrafa naturalista e guia certificada, especialista em aviturismo e nas paisagens místicas do Mato Grosso.",
    image: require("../assets/images/Aline.png"),
    languages: ["Português", "Inglês", "Espanhol"],
    specialties: ["Fotografia de Natureza", "Centro Geodésico", "Observação de Aves"],
  },
];
...
export default function GuiasChapadaScreen({ navigation }) {
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.content}>
          <Text style={styles.title}>Guias na Chapada dos Guimarães</Text>
