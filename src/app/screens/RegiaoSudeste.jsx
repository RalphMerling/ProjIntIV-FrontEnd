...
export default function RegiaoSudesteScreen({ navigation }) {
  const destinations = [
    {
      id: 1,
      city: "Rio de Janeiro",
      ...
      guides: "2 guias",
      description:
        "Cristo Redentor, Pão de Açúcar, Copacabana, samba e o carnaval mais famoso do mundo.",
      image: require("../assets/images/Rio.png"),
    },
    {
      id: 2,
      city: "São Paulo",
      ...
      guides: "2 guias",
      description:
        "Metrópole vibrante com gastronomia mundial, museus de arte, shows internacionais.",
      image: require("../assets/images/São Paulo.png"),
    },
  ];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.title}>Região Sudeste</Text>
        </View>
        ...
        {destinations.map((item) => (
          <View key={item.id} style={styles.card}>
            ...
            <View style={styles.cardFooter}>
              ...
              <TouchableOpacity
              onPress={() => {
                if (item.city === "Rio de Janeiro") {
                  navigation.navigate("guiasrio"); //ALTERAÇÃO
                } else if (item.city === "São Paulo") {
                  navigation.navigate("guiassaopaulo"); //ALTERAÇÃO
                }
              }}
            >
