...
const guides = [
  {
    ...
    price: "R$ 480/dia",
    rating: "5",
    reviews: "201 avaliações",
    experience: "13 anos de experiência",
    description:
      "Mestre de capoeira e guia cultural, levo você à alma afro-brasileira de Salvador como nenhum outro.",
    image: require("../assets/images/Bruno.png"),
    languages: ["Português", "Inglês", "Espanhol"],
    specialties: ["Candomblé", "Pelourinho", "Capoeira"],
  },
  {
    id: 2,
    name: "Yara dos Santos",
    phone: "9999999",
    price: "R$ 440/dia",
    rating: "4.9",
    reviews: "167 avaliações",
    experience: "11 anos de experiência",
    description:
      "Jornalista e guia apaixonada, especialista em gastronomia baiana e no sincretismo cultural do Nordeste.",
    image: require("../assets/images/Yara.png"),
    languages: ["Português", "Inglês"],
    specialties: ["Gastronomia Baiana", "História", "Festas Populares"],
  },
];
...
export default function GuiasManausScreen({ navigation }) {
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.content}>
          <Text style={styles.title}>Guias em Salvador</Text>
