...
const guides = [
  {
    ...
    description:
      "Jornalista gastronômico e guia cultural, navego com você pelos 12 mil restaurantes e museus de classe mundial de SP.",
    image: require("../assets/images/André.png"),
    languages: ["Português", "Inglês", "Japonês"],
    specialties: ["Gastronomia Mundial", "Arte Contemporânea", "Liberdade e Bixiga"],
  },
  {
    id: 2,
    ...
    description:
      "Arquiteta e curadora cultural, apresento São Paulo como a capital das artes e do design da América Latina.",
    image: require("../assets/images/Patricia.png"),
    languages: ["Português", "Inglês", "Espanhol"],
    specialties: ["Arquitetura", "MASP", "Vila Madalena"],
  },
];
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.content}>
          <Text style={styles.title}>Guias em São Paulo</Text>
