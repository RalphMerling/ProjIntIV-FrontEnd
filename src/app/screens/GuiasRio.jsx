...
const guides = [
  {
    ...
    price: "R$ 520/dia",
    rating: "4.9",
    reviews: "234 avaliações",
    experience: "14 anos de experiência",
    description:
      "Carioca raiz de Santa Teresa, levo você ao Rio que só os moradores conhecem: do morro ao asfalto com muito axé.",
    image: require("../assets/images/ThiagoRio.png"),
    languages: ["Português", "Inglês", "Espanhol"],
    specialties: ["Cristo Redentor", "Favela Tour", "Samba e Carnaval"],
  },
  {
    id: 2,
    ...
    price: "R$ 480/dia",
    rating: "5",
    reviews: "198 avaliações",
    experience: "10 anos de experiência",
    description:
      "Especialista no Rio da zona sul ao centro histórico, com roteiros sob medida para cada perfil de viajante.",
    image: require("../assets/images/Beatriz.png"),
    languages: ["Português", "Inglês", "Italiano"],
    specialties: ["Praias", "Gastronomia", "Vida Noturna"],
  },
];
...
export default function GuiasRioScreen({ navigation }) {
  return (
