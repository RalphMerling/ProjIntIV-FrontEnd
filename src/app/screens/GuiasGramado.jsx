...
const guides = [
  {
    ...
    price: "R$ 450/dia",
    rating: "4.9",
    reviews: "156 avaliações",
    experience: "10 anos de experiência",
    description:
      "Descendente de italianos da Serra Gaúcha, levo você pelas cantinas, chocolaterias e paisagens de tirar o fôlego.",
    image: require("../assets/images/Gustavo.png"),
    languages: ["Português", "Inglês", "Italiano"],
    specialties: ["Natal Luz", "Chocolate Artesanal", "Vinícolas"],
  },
  {
    id: 2,
    name: "Renata Hoffmann",
    phone: "9999999",
    price: "R$ 420/dia",
    rating: "4.8",
    reviews: "138 avaliações",
    experience: "8 anos de experiência",
    description:
      "Sommelier certificada e guia cultural, especialista em enoturismo pela Serra Gaúcha e no festival de cinema de Gramado.",
    image: require("../assets/images/Renata.png"),
    languages: ["Português", "Inglês", "Espanhol"],
    specialties: ["Enoturismo", "Arquitetura Germânica", "Festival de Cinema"],
  },
];
...
export default function GuiasGramadoScreen({ navigation }) {
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.content}>
          <Text style={styles.title}>Guias em Gramado</Text>
